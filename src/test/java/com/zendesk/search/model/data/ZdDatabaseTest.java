...
class ZdDatabaseTest {
    ...
    @Test
    void jsonPropToJavaField_returns_mapping_of_json_property_names_to_java_fields() throws Exception {
        Map<String, String> map = Whitebox.invokeMethod(zdDatabase,
                "jsonPropToJavaField", Organization.class);
